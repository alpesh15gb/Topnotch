        ...
        <View className="flex-1 bg-gray-50">
            ...
            <ScrollView className="flex-1 p-4">
                <View className="items-center justify-center mt-20">
                    ...
                    <Text className="text-gray-500 text-lg font-medium">No sales orders found</Text>
                    <Text className="text-gray-400 text-sm mt-1">Tap the + button to create a new one</Text>
                    <TouchableOpacity className="mt-6 bg-accent px-6 py-3 rounded-xl">
